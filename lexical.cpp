...
bool isKeyword(char *str)						//check if the given substring is a keyword or not
{
    if (!strcmp(str, "if") || !strcmp(str, "else") ||
        ...
        || !strcmp(str, "namespace") || !strcmp(str, "switch")
        || !strcmp(str, "unsigned") || !strcmp(str, "void")
        || !strcmp(str, "static") || !strcmp(str, "struct")
        || !strcmp(str, "sizeof") || !strcmp(str,"long")
        || !strcmp(str, "iostream") || !strcmp(str, "typedef")
        || !strcmp(str, "enum") || !strcmp(str, "const")
        || !strcmp(str, "union") || !strcmp(str, "main")
        || !strcmp(str,"using")) 
        {
            return true;
        }
...
int main()
{
    char c[100] = "#include<iostream> using namespace std; int main() { int a =10,b=20; int c = a+b; }";
    parse(c);
    return 0;
}